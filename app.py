...
st.markdown("<p style='text-align: center; font-size: 2.8rem; font-weight: 800; line-height: 0.8; text-shadow: 2px 2px 4px #000000;'>Stock Trend Forecaster</p>", unsafe_allow_html=True)
