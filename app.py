...
# TITLE
st.markdown("<p style='text-align: center; font-size: 6rem; line-height: 0.4;'>🕵️</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 2.8rem; font-weight: 800; line-height: 0.8; text-shadow: 0px -5px 10px #000000;'>Stock Trend Forecaster</p>", unsafe_allow_html=True)
